...
private static final String UPDATE_EMP_DETAILS_BY_ENO="UPDATE EMP SET ENAME=?,JOB=?,SAL=? WHERE EMPNO=?";
private static final String DELETE_EMP_DETAILS_BY_ENO="DELETE FROM EMP WHERE EMPNO=?";
    @Autowired
	...
	@Override	
	public int deleteEmployeeByNo(int eno) {

		int count=jt.update(DELETE_EMP_DETAILS_BY_ENO,eno);
		return count;
	}
