...
private static final String GET_EMP_DETAILS="SELECT EMPNO,ENAME,JOB,SAL FROM EMP1";
private static final String GET_EMP_DETAILS_BY_ENO="SELECT EMPNO,ENAME,JOB,SAL FROM EMP1 WHERE EMPNO=?";
private static final String UPDATE_EMP_DETAILS_BY_ENO="UPDATE EMP1 SET ENAME=?,JOB=?,SAL=? WHERE EMPNO=?";
private static final String DELETE_EMP_DETAILS_BY_ENO="DELETE FROM EMP1  WHERE EMPNO IN ";
    @Autowired
