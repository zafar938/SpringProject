...
public class EmployeePaginationController {
	...
	public String fetchPageData(@PageableDefault(page=0,size=3,sort="ename",direction=Direction.ASC)
	       Pageable pageable,Map<String,Object>map,HttpServletRequest req) {
		
		//keep page size in session scope
